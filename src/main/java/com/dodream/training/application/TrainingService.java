...
import com.dodream.training.util.TrainingApiExecuter;
...
public class TrainingService {
    ...
    public BootcampListApiResponse getList(
        ...
        String result = trainingApiExecuter.callBootcampListApi(
    ...
    public BootcampDetailApiResponse getDetail(
        ...
        String result = trainingApiExecuter.callBootcampDetailApi(
