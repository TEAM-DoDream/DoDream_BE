...
import com.dodream.core.infrastructure.cache.annotation.CacheableAnnotation;
...
public abstract class BaseCacheAbstract {
    ...
    protected String generateCacheKey(ProceedingJoinPoint joinPoint, CustomCacheable customCacheable) {
    ...
    protected String generateCacheKey(ProceedingJoinPoint joinPoint, CustomCacheableWithLock customCacheableWithLock) {
